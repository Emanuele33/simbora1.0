...
/*      html, body {
  ...
  <body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0">
        <?php $id = $_GET['id']; ?>
        <div id="forms">
            <form action="processa_horario.php?id=<?=$id?>" method="POST" style="margin-top: 5%">
                <input type="text" name="nome" placeholder="Nome"><br>  
                <input type="text" name="paradaorigem" id="txtOrigem" placeholder="Parada de Origem"><br>
                <input type="text" name="paradadestino" id="txtDestino" placeholder="Parada de Destino"><br>
                <select name="horario" style="margin-left: -3%">
                ...
                <input class="btn btn-custom btn-lg" style="width: 13%; font-size: 12px; margin-left: -4%" type="button" value="Calcular dist&acirc;ncia" onclick="CalculaDistancia()" class="btnNew" />
                <br>    
                <input class="btn btn-custom btn-lg" style="width: 13%; font-size: 12px; margin-left: -4%" type="submit" name="Cadastrar Rotas" class="btnNew">
                <br>
                <br>
                <a style="margin-left: -7%" href="tabelahorarios.php?id=<?=$id?>">Veja meninas com sua mesma rota</a>
            </form>
        </div>        
    </table>
    ...
    <div style="/*padding: 10px 0 0; clear: both; margin-left: 600px; margin-top: -200px*/ z-index: 1;/* position: absolute*/; height: 100%; width: 100%; padding: 0px; border-width: 0px; margin: 0px; left: 0px; top: 0px;" id="mapas">
        <iframe width="750" scrolling="no" height="350" frameborder="0" id="map" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?saddr=são paulo&daddr=rio de janeiro&output=embed" style="margin-top: -42%; width: 60%; height: 89%; float: right;"></iframe>
